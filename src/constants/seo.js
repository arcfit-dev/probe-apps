export const SEO = {
  ...
  themeColor: '#0E2647',
  socials: {
    twitter: 'https://twitter.com/probeapps',
    linkedin: 'https://linkedin.com/company/probeapps',
    instagram: 'https://instagram.com/probeapps',
  },
  contact: {
    email: 'hello@probeapps.com',
...
export const FAQ_DATA = [
  ...
  },
  {
    ...
    a: 'Probe connects to all your lead sources — WhatsApp, missed calls, property portals like 99acres and MagicBricks, website inquiries, email and referrals — and funnels every lead into a single unified inbox automatically.',
  },
  {
  ...
  },
  {
    ...
    a: 'Yes. Unlike generic CRMs, Probe is designed from the ground up for real estate workflows — property matching, site visit scheduling, deal tracking and commission-based analytics. Every feature is tailored to how brokers actually work.',
  },
  {
    q: 'How much does Probe cost?',
    a: 'Probe is currently in pre-launch. Pricing will be announced soon. You can join the waitlist today for early access and exclusive launch pricing. We offer a 14-day free trial with no long-term contracts.',
  },
];
